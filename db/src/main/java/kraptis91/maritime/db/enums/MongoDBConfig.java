...
enum MongoDBConfig {
    ...
    MongoDBConfig() {
        ...
        Config localDirConfig =
            // ConfigFactory.parseFile(Paths.get("C:/Users/konstantinos/Downloads/" + confFile).toFile());
            ConfigFactory.parseFile(Paths.get(DirectoryUtils.getDefaultDownloadsDirectory()
                + "/" + confFile).toFile());
